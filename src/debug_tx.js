...
const run = () => {
    try {
        ...
        const unspentTxOuts = (0, blockchain_1.getUnspentTxOuts)();
        ...
        const tx = (0, wallet_1.createTransaction)(receiverAddress, amount, privateKey, unspentTxOuts, []);
        console.log('Transaction created:', JSON.stringify(tx, null, 2));
        console.log('Validating transaction...');
        const isValid = (0, transaction_1.validateTransaction)(tx, unspentTxOuts);
        if (isValid) {
...
run();
//# sourceMappingURL=debug_tx.js.map