...
const saveBlockchain = async (force = false) => {
        ...
        try {
            ...
            writeStream.on('finish', () => {
                try {
                    ...
                    console.log('Error renaming blockchain tmp file: ' + err.message);
                    reject(err);
                }
            });
            writeStream.write('[');
            ...
            console.log('Error in saveBlockchain streaming: ' + e.message);
            reject(e);
        }
    });
};
